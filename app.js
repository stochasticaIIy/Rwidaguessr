(() => {
  ...
  function renderMarketFairness(valuation, actualPrice) {
    ...
    if (ui.marketGapVal) {
      ...
      if (state.language === 'ar') {
        ui.marketGapVal.innerHTML = `<span dir="ltr" style="unicode-bidi: isolate;"><bdi>${gapSign}${money(gapDiff)}</bdi></span> <span dir="ltr" style="unicode-bidi: isolate;"><bdi>(${pctFormatted})</bdi></span>`;
      } else {
